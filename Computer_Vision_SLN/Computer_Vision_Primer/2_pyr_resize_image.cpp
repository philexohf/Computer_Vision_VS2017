...
int main()
{
	...
	g_srcImage = imread("./image/summer.png");//测试图像尺寸需被2的N次方整除，N为可以缩放的次数
...
static void ShowHelpText()
{
	printf("\n\n\t按键操作: \n\n"
		"\t\t【ESC】或者【Q】- 退出程序\n"
		"\t\t【1】或者【W】- 进行基于【resize】函数的图片放大\n"
		"\t\t【2】或者【S】- 进行基于【resize】函数的图片缩小\n"
		"\t\t【3】或者【A】- 进行基于【pyrUp】函数的图片放大\n"
		"\t\t【4】或者【D】- 进行基于【pyrDown】函数的图片缩小\n"
	);
}